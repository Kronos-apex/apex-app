...
const A = afirmador('panel del coach');
...
await afirmaPantalla(ev, A, { nombre: 'home del coach', sel: '#p-home', minTxt: 80, ancho: 1180 });
...
await afirmaPantalla(ev, A, { nombre: 'ficha del asesorado', sel: '#p-detail', minTxt: 80, ancho: 1180 });

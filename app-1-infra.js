...
const defaultExercises=[
  ...
  {id:'e60',name:'Aducción de Cadera en Máquina',muscle:'piernas',type:'Aislamiento',sets:4,reps:15,icon:'🫶',desc:'Sentado, cierra las piernas contra la resistencia. Trabaja el aductor y cara interna del muslo.',descSimple:'Siéntate en la máquina con las piernas abiertas sobre los soportes. Junta las piernas con control contra la resistencia, sintiendo la cara interna del muslo, y regresa despacio sin dejar que el peso te abra de golpe.',muscleLabel:'Cara interna del muslo',ytQuery:'aducción cadera máquina inner thigh tutorial'},

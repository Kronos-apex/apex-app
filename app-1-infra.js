...
const defaultExercises=[
  ...
  {id:'e81',name:'Mountain Climbers',muscle:'core',type:'Bodyweight',sets:3,reps:'20',icon:'🌀',desc:'Posición de plancha alta (manos en el suelo), lleva las rodillas alternadas hacia el pecho sin dejar caer ni elevar la cadera. La columna permanece neutra durante todo el movimiento. Reps = repeticiones totales (10 por pierna). Velocidad moderada antes de velocidad alta.',descSimple:'Apoya las manos en el suelo como en una flexión. Sin mover la cadera, lleva una rodilla hacia el pecho y regrésala, luego la otra. El cuerpo queda como una tabla que no se mueve excepto las piernas. Cuenta 1 repetición por cada pierna.',muscleLabel:'Core, cardio y cadera',ytQuery:'mountain climbers técnica correcta core tutorial'},
  ...
  {id:'e181',name:'Escaladores',muscle:'core',type:'HIIT',sets:3,reps:30,icon:'⛰️',env:['corporal','casa','parque','gym'],desc:'Acondicionamiento de core: desde plancha alta llevas las rodillas al pecho de forma rápida y alterna, sin levantar la cadera. Trabaja abdomen y eleva pulsaciones.',descSimple:'En plancha alta, lleva las rodillas al pecho alternando rápido manteniendo la cadera baja y estable.',muscleLabel:'Core y cardio',ytQuery:'escaladores mountain climbers técnica'},
  ...
  {id:'e208',name:'Caminata del Granjero',muscle:'biceps',type:'Funcional',sets:3,reps:30,icon:'🧳',env:['casa','gym'],track:'tiempo',desc:'Fuerza de agarre y core total: caminas cargando peso a los lados manteniendo el torso alto y firme. Construye antebrazos, trapecio y estabilidad de tronco.',descSimple:'Carga una mancuerna pesada en cada mano y camina erguido con el core firme y los hombros atrás, sin encorvar.',muscleLabel:'Agarre, antebrazo y core',ytQuery:'caminata del granjero farmer carry'},
  ...
  {id:'e221',name:'Pullover con Mancuerna',muscle:'pecho',type:'Aislamiento',sets:3,reps:12,icon:'🌙',env:['casa','gym'],desc:'Tumbado con una mancuerna sostenida con las dos manos sobre el pecho, bajas en arco por detrás de la cabeza con los codos semiflexionados y vuelves. Estira la caja torácica y trabaja pectoral y dorsal a la vez. Rango cómodo: nunca forzar el hombro por detrás.',descSimple:'Acostado en el banco, sostén una mancuerna con las dos manos sobre el pecho. Bájala en arco por detrás de la cabeza hasta donde te sea cómodo y regrésala. Sentirás que se abre el pecho. No fuerces el hombro hacia atrás.',muscleLabel:'Pecho y dorsal',ytQuery:'pullover con mancuerna técnica correcta'},
  ...
  {id:'e224',name:'Press Francés con Barra Z',muscle:'triceps',type:'Aislamiento',sets:3,reps:12,icon:'💪',env:['gym'],desc:'Extensión tumbado con barra Z: el agarre angulado de la Z es más amable con la muñeca y el codo que la barra recta, y permite bajar hacia la frente o algo por detrás para estirar más. Codos fijos apuntando al techo; solo gira el antebrazo.',descSimple:'Acostado, con la barra Z sobre el pecho y los brazos estirados. Dobla los codos bajando la barra hacia la frente y vuelve a estirar. Los codos no se mueven de sitio. La barra Z es más cómoda para la muñeca que la recta.',muscleLabel:'Tríceps',ytQuery:'press frances con barra z tecnica'},
  ...
  {id:'e227',name:'Curl de Bíceps en Banco Inclinado',muscle:'biceps',type:'Aislamiento',sets:3,reps:12,icon:'📐',env:['gym'],desc:'Sentado en banco inclinado con los brazos colgando por detrás del cuerpo: esa posición pre-estira la cabeza larga del bíceps y elimina el impulso de cadera, así que trabaja con menos peso pero mucho más limpio. Codos quietos pegados al torso.',descSimple:'Siéntate en un banco inclinado hacia atrás y deja los brazos colgando a los lados. Sube las mancuernas doblando solo el codo, sin mover el hombro. Vas a usar menos peso del normal y aun así se siente más: eso es buena señal.',muscleLabel:'Bíceps (cabeza larga)',ytQuery:'curl inclinado con mancuernas banco inclinado'}
];
const DB={
  clients:ld('ax_c',[]),

...
*Última actualización: 2026-06-10 · Marca: **AVI** · **v2.0 (auth real + RLS, EN PRODUCCIÓN)** · **apex-v130** · Suite **123/123** verde · repo local: `Desktop/AVI/apex-app` · Tagline: "Entrenamiento con nombre propio" · PO: Camilo Andrés*
...
**🖼️ FOTOS STOCK POR REEMPLAZAR — 46 (no son AVI).** Detección por tamaño: las AVI son **720²**, las stock viejas **320×213/320×320** (gym rojo/azul, modelo genérico, confirmado visualmente con e1). 64 ya son AVI. Lista completa agrupada por músculo exportada a **`Desktop/FOTOS-STOCK-POR-REEMPLAZAR.txt`**. IDs: e1,e7,e10,e12,e15,e17,e18,e20,e29,e32,e33,e34,e35,e37,e39,e40,e41,e44,e46,e48,e49,e59,e60,e61,e62,e64,e65,e66,e67,e68,e69,e70,e73,e80,e81,e82,e87,e88,e95,e96,e100,e101,e102,e103,e106,e107. Camilo las regenera en Gemini → me las pasa nombradas → proceso e integro (mismo flujo).
...
**Otras pendientes:** reemplazar 46 fotos stock (Camilo las genera); revisar e4. ✅ Glosario ampliado (15→29 términos: Valsalva, tempo, lumbar, femoral, dorsal, glúteo medio, etc.; apex-v131). Datos prod de Miguel: ver memorias.
---

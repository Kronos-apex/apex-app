...
*Última actualización: 2026-07-02 · Marca: **AVI** · **v2.0 (auth real + RLS, EN PRODUCCIÓN)** · **avi-v244** · Catálogo **212 ejercicios** (e1–e214; +50 nuevos e165–e214: movilidad, HIIT/funcional, antebrazo/grip — **con foto, ya registrados en `EX_IMG_IDS` en v234**) + **gate por nivel** en el generador · Suite **267/267** verde · repo local: `Desktop/AVI/apex-app` · Tagline: "Entrenamiento con nombre propio" · PO: Camilo Andrés*

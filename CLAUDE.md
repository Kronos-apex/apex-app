...
*Última actualización: 2026-07-17 · Marca: **AVI** · **v2.x (auth real + RLS + guiado único, EN PRODUCCIÓN)** · **avi-v362** · Catálogo **212 ejercicios** (e1–e214, todos con foto) · Suite **385/385** verde · QA: hook 11 checks (`scripts/hooks/`, `core.hooksPath`) + CI + harnesses `scripts/e2e/` (`_verify-water` = agua+pasos, `_verify-news` = tour de novedades) · repo local: `Desktop/AVI/apex-app` · Tagline: "Entrenamiento con nombre propio" · PO: Camilo Andrés*

*Hábitos: 💧 agua (v300) + 👟 PASOS (SESIÓN J, v362, 2026-07-17) en la tarjeta `#cn-habits` — meta 8.000, input SET + atajo +1.000, recordatorio en el cron de las 5pm. Falta verificación de Fable. Adopción push al fin del entreno ya existía (v325).*

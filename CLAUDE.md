...
> **PENDIENTE TÉCNICO:** limpiar los datos ya corruptos (el tope nuevo evita los futuros, no borra
> los 800.000.090 kg que ya están) · `app_errors` deja insertar a `anon` y guarda `uid` NULL, así

...
- ⚠️ **Los archivos de este repo van con CRLF: un patrón de sabotaje que lleve `\n` suelto NO SE APLICA NUNCA.** Pasó en `_sabotaje-f6.mjs` y el runner lo reportó como «NO SE APLICÓ» — pero es un renglón que se lee de reojo igual que un ✅, y en un listado de 15 se pierde. Los patrones se anclan en **una sola línea**, y el runner tiene que gritar cuando el texto no aparece exactamente 1 vez (el de F5 ya lo hacía: por eso se supo).

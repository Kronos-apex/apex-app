...
*Última actualización: 2026-07-16 · Marca: **AVI** · **v2.x (auth real + RLS + guiado único, EN PRODUCCIÓN)** · **avi-v360** · Catálogo **212 ejercicios** (e1–e214, todos con foto) · Suite **376/376** verde · QA: hook 11 checks (`scripts/hooks/`, `core.hooksPath`) + CI + harnesses `scripts/e2e/` (`_verify-v317` = orden inteligente, ahora con mensaje-sin-leer + lead) · repo local: `Desktop/AVI/apex-app` · Tagline: "Entrenamiento con nombre propio" · PO: Camilo Andrés*

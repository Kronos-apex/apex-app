...
- [ ] Pasos diarios: meta por asesorado, registro manual, gráfica semanal
...
*Última actualización: 2026-07-12 · Marca: **AVI** · **v2.x (auth real + RLS + guiado único, EN PRODUCCIÓN)** · **avi-v327** · Catálogo **212 ejercicios** (e1–e214, todos con foto) · Suite **312/312** verde · QA: hook 11 checks (`scripts/hooks/`, `core.hooksPath`) + CI + harnesses `scripts/e2e/` · repo local: `Desktop/AVI/apex-app` · Tagline: "Entrenamiento con nombre propio" · PO: Camilo Andrés*

*Hitos por sesión: **`docs/bitacora.md`** (los 3 más recientes: **v327 fix del guard de auto-update** (no protegía la pantalla de cierre ni el tour → el reload borraba los logros + el nudge de push; hallazgo convergente de Julián+Lucas) · **v326 adopción push — activar notificaciones al TERMINAR el entreno** · **v325 auto-actualización SEGURA de la app**).*
